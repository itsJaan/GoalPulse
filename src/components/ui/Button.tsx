...
export function Button({ title, onPress, loading = false, disabled = false, variant = 'primary', style, textStyle }: ButtonProps) {
  ...
  return (
    ...
    >
      {loading
        ? <ActivityIndicator color={variant === 'primary' ? Colors.text.inverse : Colors.accent.green} size="small" />
...
const styles = StyleSheet.create({
  ...
  ghostText: { color: Colors.accent.green },
})
